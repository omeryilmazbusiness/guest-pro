...
> = {
  tr: {
    ...
    scanStatusRequesting: "Kamera açılıyor",
    scanStatusScanning: "Taranıyor",
    scanStatusReading: "Okunuyor",
    scanStatusSuccess: "Pasaport okundu",
    scanStatusError: "MRZ hizalayın",
    scanAlignError: "Yaklaşın — alt MRZ satırları net görünmeli",
  ...
  en: {
    ...
    scanStatusRequesting: "Starting camera",
    scanStatusScanning: "Scanning",
    scanStatusReading: "Reading",
    scanStatusSuccess: "Passport read",
    scanStatusError: "Align MRZ",
    scanAlignError: "Move closer — keep MRZ lines clear at the bottom",
  ...
  ar: {
    ...
    scanStatusRequesting: "جاري فتح الكاميرا",
    scanStatusScanning: "جاري المسح",
    scanStatusReading: "جاري القراءة",
    scanStatusSuccess: "تم قراءة الجواز",
    scanStatusError: "محاذاة MRZ",
    scanAlignError: "اقترب — يجب أن تكون أسطر MRZ واضحة في الأسفل",
  ...
  ur: {
    ...
    scanStatusRequesting: "کیمرہ کھل رہا ہے",
    scanStatusScanning: "سکین ہو رہا ہے",
    scanStatusReading: "پڑھا جا رہا ہے",
    scanStatusSuccess: "پاسپورٹ پڑھ لیا گیا",
    scanStatusError: "MRZ سیدھ میں لائیں",
    scanAlignError: "قریب آئیں — نیچے MRZ لائنیں واضح ہونی چاہئیں",
