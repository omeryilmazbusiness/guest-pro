...
import { loginAsManager } from "@/lib/auth-login";
...
export default function ManagerLoginPage() {
  ...
  const mutation = useMutation({
    mutationFn: ({ email, password }: FormValues) => loginAsManager(email, password, tenantSlug),
    onSuccess: (res) => {
      setToken(res.token);
  ...
  return (
    <HotelLoginShell
      title="Staff sign in"
      subtitle="Managers and reception — email and password"
      formError={formError}
    >
      <Form {...form}>
        <form
